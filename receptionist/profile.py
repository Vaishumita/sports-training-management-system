...
def update_profile_receptionist(receptionist_id):
    ...
    for line in lines:
        ...
        if len(parts) >= 7 and parts[0] == receptionist_id and parts[3] == "RECEPTIONIST":
            found = True
    ...
    if not found:
        print("Receptionist profile not found.")
        return
